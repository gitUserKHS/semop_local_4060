...
- Preserve the RTX 4060 8GB strategy of operator-algebra-first reasoning with GPU assistance, rather than shifting the system toward heavyweight generation-first behavior.
...
## Source of Truth
For the expanded version of these goals, see `docs/user_primary_goals.md` and `docs/user_ultimate_agi_goal.md`.
