...
def main() -> None:
    parser = argparse.ArgumentParser(description='Run a common SemOp evaluator snapshot across premise, CP, and VLSO tasks.')
    parser.add_argument('--hidden-premises')
    parser.add_argument('--cp-input')
    parser.add_argument('--cp-hidden-input')
    parser.add_argument('--vlso-input')
    parser.add_argument('--vlso-real-image-input')
