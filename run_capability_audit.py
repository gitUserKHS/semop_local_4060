...
from semop import CapabilityAuditRunner, CapabilityImprovementRunner


def main() -> None:
    _reexec_into_preferred_python()
    parser = argparse.ArgumentParser(description='Run a consolidated SemOp capability audit')
    parser.add_argument('--workspace', default='.')
    parser.add_argument('--bootstrap-missing', action='store_true')
    parser.add_argument('--output', default='data/unified_semop_gui_run/capability_audit_report.json')
